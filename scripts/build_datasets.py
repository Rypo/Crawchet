...
def get_parser():
    ...
    parser.add_argument('--readable_out', type=str, default='../data/staged/jsonhtml/readabled.json')
...
if __name__ == '__main__':
    ...
    df_master = transform.parallel_simplify(args.df_out, args.readable_out, n_jobs=-5)
